                ...
                <div className="custom-select">
                    ...
                    <div>
                        {transcriptNames.map((point) => {
                            return <span class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold text-gray-700 bg-gray-200 rounded" style={{color: transcriptColor()}}>{point}</span>
                        }
                        )}
