                ...
                <div className="custom-select">
                    ...
                    <div>
                        {transcriptNames.map((point) => {
                            return <span className="inline-flex items-center justify-center px-2 py-1 text-xs font-bold text-gray-700 bg-gray-200 rounded" style={{color: "red"}}>{point}</span>
                        }
                        )}
